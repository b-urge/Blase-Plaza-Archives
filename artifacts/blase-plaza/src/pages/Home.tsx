  ...
  return (
    <div className="win98-window p-6 h-full">
      ...
      <p className="mb-6 leading-relaxed">
        This database serves as the central repository for field surveys of commercial plazas in Broward County slated for demolition or significant redevelopment.
      </p>
